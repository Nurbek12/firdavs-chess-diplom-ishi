<template>
  <v-container>
    <Scoreboard :players="players" :current="current" :moves="history.moves" whiteGraveyard={this.state.whiteGraveyard} blackGraveyard={this.state.blackGraveyard} />
    <Board :squares="squares" :checkmate="checkmate" :message="message" selectedSquare={this.state.selectedSquare} lastMove={this.state.history.lastMove()} onClick={(index) => this.handleClick(index) }/>
  </v-container>
</template>
...
const squares = ref(initializeBoard())
const message = ref('Welcome! White\'s turn.')
const players = ref(players)
const current = ref(players['white'])
const selectedSquare = ref(null)
const whiteGraveyard = ref([])
const blackGraveyard = ref([])
...
const initializeBoard = () => {
  ...
  // Black pieces
  squares[0] = new Square(0, 0, new Rook('black', undefined));
  squares[1] = new Square(0, 1, new Knight('black', undefined));
  squares[2] = new Square(0, 2, new Bishop('black', undefined));
  squares[3] = new Square(0, 3, new Queen('black', undefined));
  squares[4] = new Square(0, 4, new King('black', undefined));
  squares[5] = new Square(0, 5, new Bishop('black', undefined));
  squares[6] = new Square(0, 6, new Knight('black', undefined));
  squares[7] = new Square(0, 7, new Rook('black', undefined));
